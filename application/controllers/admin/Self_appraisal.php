...
class Self_appraisal extends MY_Controller {
	...
	public function kirim_form(){
		...
		/* ini emailnya */
			...
			<p>7. Apabila terdapat kesulitan dalam pelaksanaan Employee Performance Appraisal ini, mohon untuk dapat menghubungi Dept. HR (Sara Putrikita/sara@pinc.group/ +62851 5788 1097 )</p>
		...
		redirect('admin/Self_appraisal/index');
