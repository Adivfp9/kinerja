...
class Appraisal extends MY_Controller {
	...
	public function kirim_selfapp(){
		$data['title'] = 'Table Appraisal Form';
		$data['get_karyawan'] = $this->master_model->get_karyawan();
		$this->load->view('admin/includes/_header');
		$this->load->view('admin/appraisal/kirim_selfapp', $data);
		$this->load->view('admin/includes/_footer');
	}
    public function kirim_spvapp(){
		$data['title'] = 'Table Appraisal Form';
		$data['get_karyawan'] = $this->master_model->get_karyawan();
		$this->load->view('admin/includes/_header');
		$this->load->view('admin/appraisal/kirim_spvapp', $data);
		$this->load->view('admin/includes/_footer');
	}
	public function add(){
